...
local repositoryURL = "https://raw.githubusercontent.com/BachErik/WinDoofOS/master/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "WinDoofOS")
...
local installerMenu = menu:addContextMenuItem("WinDoofOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("WinDoofOS HDD")
	end
	...
	EEPROMProxy.setLabel("WinDoofOS EFI")
